...
def main():
    ...
    ham_txt = pickle.load(open(dataset_path + "ham_train_dev", "r"))
    spam_txt = pickle.load(open(dataset_path + "spam_train_dev", "r"))
    ...
    try:
        ...
        file = open("train/word_count_att_names", "w")
        ...
        for att_name_idx in xrange(len(word_count_att_names)):
        	df[word_count_att_df_names[att_name_idx]] = word_count_matrix_t[att_name_idx]
    ...
    file = open("resultados/DecisionTreeClf/best_decision_tree_clf", "w")
